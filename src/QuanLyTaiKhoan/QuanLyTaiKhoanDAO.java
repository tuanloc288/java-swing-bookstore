 ...
 * @author Admin
 */
public class QuanLyTaiKhoanDAO extends mainBUS_DAO.mainDAO{
    ...
    public ArrayList<TaiKhoan> readDB(){
        ...
        try {
              ...
              while(rs.next()){
                  dstk.add(new TaiKhoan(rs.getString(1),rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(5), rs.getString(6)));
              }
        }
        catch (Exception e){
            e.printStackTrace();
